...
import jakarta.validation.constraints.Email; // Necesario para @Email en parámetros
import jakarta.validation.constraints.NotBlank; // Necesario para @NotBlank en parámetros
